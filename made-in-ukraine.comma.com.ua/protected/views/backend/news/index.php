...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=News::model()->getAttributeLabel('id');?></th>
	            <th><?=NewsTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th><?=News::model()->getAttributeLabel('code_name');?></th>  
	            <th><?=News::model()->getAttributeLabel('datetime');?></th>  
	            <th width="1%"><?=News::model()->getAttributeLabel('active');?></th>
