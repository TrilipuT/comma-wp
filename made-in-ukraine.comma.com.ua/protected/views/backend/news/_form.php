        ...
        <div class="tab-content">
        	...
        	<div class="tab-pane fade in active" id="tabs-info" style="height1: 400px;"> 
        		...
        		<div class="block admin-image">
					...
					<?php if($this->getAction()->id == 'update' && !empty($model->gif_filename) && file_exists($_SERVER['DOCUMENT_ROOT'].News::PATH_IMAGE_GIF.$model->gif_filename) ):
				               
				        echo CHtml::image(News::PATH_IMAGE_GIF.$model->gif_filename).'<br />';  
				...
				*/?>
				...
				<div class="block admin-image">
					...
					<?php if($this->getAction()->id == 'update' && !empty($model->image_filename) && file_exists($_SERVER['DOCUMENT_ROOT'].News::PATH_IMAGE.$model->image_filename) ):
				               
				        echo CHtml::image(News::PATH_IMAGE.$model->image_filename).'<br />';  
                ...
                <div class="block admin-image">
                    ...
                    <?php if($this->getAction()->id == 'update' && !empty($model->share_image) && file_exists($_SERVER['DOCUMENT_ROOT'].News::PATH_SHARE_IMAGE.$model->share_image) ):

                        echo CHtml::image(News::PATH_SHARE_IMAGE.$model->share_image).'<br />';
		...
		<? /*
		    ...
		    */?>    
			...
			<div class="tab-pane fade" id="tabs-tags" style="min-height: 400px;">
                <?php $tagsItems = NewsHasTegs::model()->withNews($model->id)->findAll();
	                    ...
	                    <?php foreach($tagsItems as $HasTags): ?>  
	                        <?php if(count($this->languageList) > 0): ?>
	                            ...
	                            <div class="row">  
	                                ...
	                                <?php endforeach;?>
	                                <button type-data="news-tag" data-id="<?=$HasTags->id?>" class="del-tag btn btn-danger btn-mini" href="#">Удалить</button>
	                            </div>
