...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=VideoCats::model()->getAttributeLabel('id');?></th>
	            <th><?=VideoCatsTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th><?=VideoCats::model()->getAttributeLabel('code_name');?></th>  
	            <th><?=VideoCats::model()->getAttributeLabel('main');?></th>  
	            <th width="1%"><?=VideoCats::model()->getAttributeLabel('active');?></th>
