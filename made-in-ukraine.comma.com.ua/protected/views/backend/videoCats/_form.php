...
*/?> 
		...
		<div class="block">
			...
			<?php echo $form->checkBox($model,'main',array('class' => 'ibutton')); ?>
				...
				?>
					...
					<div class="tab-pane fade <?=$activeClass;?>" id="tabs-<?=$lang_id;?>">
						...
						<div class="row-elements">
							...
							<?php echo $form->textField($model_transfer,'menu_name['.$lang_id.']',array('size'=>60, 'maxlength'=>255, 'value' => $model_transfer->name)); ?>
