...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Blogs::model()->getAttributeLabel('id');?></th>
	            <th><?=ArticleTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th><?=Blogs::model()->getAttributeLabel('code_name');?></th>  
	            <th><?=Blogs::model()->getAttributeLabel('datetime');?></th>  
	            <th width="5%"><?=Blogs::model()->getAttributeLabel('active');?></th>
