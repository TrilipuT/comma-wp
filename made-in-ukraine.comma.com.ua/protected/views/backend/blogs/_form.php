        ...
        <div class="tab-content">
        	...
        	<div class="tab-pane fade in active" id="tabs-info" style="height1: 400px;">
				...
				<div class="block admin-image">
					...
					<?php if($this->getAction()->id == 'update' && !empty($model->icon_filename) && file_exists($_SERVER['DOCUMENT_ROOT'].Blogs::PATH_ICON.$model->icon_filename) ):
				               
				        echo CHtml::image(Blogs::PATH_ICON.$model->icon_filename).'<br />';  
                ...
                <div class="block admin-image">
                    ...
                    <?php if($this->getAction()->id == 'update' && !empty($model->share_image) && file_exists($_SERVER['DOCUMENT_ROOT'].Blogs::PATH_SHARE_IMAGE.$model->share_image) ):

                        echo CHtml::image(Blogs::PATH_SHARE_IMAGE.$model->share_image).'<br />';
...
*/ ?>
				...
				<div class="block">
		            <?php echo $form->label($model ,'bloger_id'); ?>
		            <?php echo $form->dropDownList($model ,'bloger_id', 
		                                            CHtml::listData(Blogers::model()->orderByOrderNum()->findAll(), 'id', 'transfer.name'),  
		                                            array('data-placeholder' => 'Выберите блогера', 'empty' => array( 0 => 'Выберите блогера'), 'class' => '')); ?>
