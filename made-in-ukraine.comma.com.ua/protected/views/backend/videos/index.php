...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Videos::model()->getAttributeLabel('id');?></th>
	            <th><?=VideosTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th><?=Videos::model()->getAttributeLabel('code_name');?></th>  
	            <th width="1%"><?=Videos::model()->getAttributeLabel('active');?></th>
