...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Blogers::model()->getAttributeLabel('id');?></th>
	            <th><?=BlogersTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th><?=Blogers::model()->getAttributeLabel('code_name');?></th>  
	            <th width="1%"><?=Blogers::model()->getAttributeLabel('active');?></th>
