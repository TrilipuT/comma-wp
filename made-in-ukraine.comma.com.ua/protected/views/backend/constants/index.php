...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Constants::model()->getAttributeLabel('id');?></th>
	            <th width=""><?=Constants::model()->getAttributeLabel('key');?></th>
	            <th><?=ConstantsTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th width="1%"><?=Constants::model()->getAttributeLabel('active');?></th>
	        ...
	        <tbody id="sortable" >
					<?php foreach($list as $item):?>
						<tr class="ui-state-default" data-id="<?=$item->id;?>" data-order=""  >
							<td><?=$item->id;?></td>
						 	<td><?=$item->key;?></td>
