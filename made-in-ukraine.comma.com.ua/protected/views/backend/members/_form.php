        ...
        <div class="tab-content">
        	...
        	<div class="tab-pane fade in active" id="tabs-info" style="height1: 400px;">
				...
				<div class="block admin-image">
					...
					<?php if($this->getAction()->id == 'update' && !empty($model->image_filename) && file_exists($_SERVER['DOCUMENT_ROOT'].Members::IMAGE_490x300.$model->image_filename) ):

						echo CHtml::image(Members::IMAGE_490x300.$model->image_filename).'<br />';
				...
				<div class="row-elements" style="width: auto;">
					<div class="block">
				...
				<div class="row-elements" style="width: auto;">
					<div class="block">
						<?php echo $form->labelEx($model,'link_fb'); ?>
						<?php echo $form->textField($model,'link_fb',array('size'=>80,'maxlength'=>255)); ?>
						<?php echo $form->error($model,'link_fb'); ?>
					</div>

					<div class="block">
						<?php echo $form->labelEx($model,'link_vk'); ?>
						<?php echo $form->textField($model,'link_vk',array('size'=>80,'maxlength'=>255)); ?>
						<?php echo $form->error($model,'link_vk'); ?>
					</div>

					<div class="block">
						<?php echo $form->labelEx($model,'link_lk'); ?>
						<?php echo $form->textField($model,'link_lk',array('size'=>80,'maxlength'=>255)); ?>
						<?php echo $form->error($model,'link_lk'); ?>
					</div>
		...
		<?php if(count($this->languageList) > 0): ?>
				...
				?>
					...
					<div class="tab-pane fade <?=$activeClass;?>" id="tabs-<?=$lang_id;?>">
						...
						<div class="row-elements">
							<div class="block">
								<?php echo $form->labelEx($model_transfer,'text_soundcloud'); ?>
								<?php echo $form->textArea($model_transfer,'text_soundcloud['.$lang_id.']',array('rows'=>30, 'cols'=>80 , 'class'=>'tiny_mce',  'value' => $model_transfer->text_soundcloud )); ?>
								<?php echo $form->error($model_transfer,'text_soundcloud'); ?>
							</div>
						</div>

						<div class="row-elements">
							<div class="block">
								<?php echo $form->labelEx($model_transfer,'text_youtube'); ?>
								<?php echo $form->textArea($model_transfer,'text_youtube['.$lang_id.']',array('rows'=>5, 'cols'=>10 , 'value' => $model_transfer->text_youtube )); ?>
								<?php echo $form->error($model_transfer,'text_youtube'); ?>
							</div>
						</div>
