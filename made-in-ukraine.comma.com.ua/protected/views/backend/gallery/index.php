...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Gallery::model()->getAttributeLabel('id');?></th>
	            <th><?=GalleryTransfer::model()->getAttributeLabel('name');?> [ru]</th>  
	            <th width="5%"><?=Gallery::model()->getAttributeLabel('datetime');?></th>
	            <th width="1%"><?=Gallery::model()->getAttributeLabel('in_article');?></th>
	            <th width="1%"><?=Gallery::model()->getAttributeLabel('active');?></th>
