...
?>
 	...
 	<div class="row-top">  
        ...
        <div class="tab-content">
			...
			<div class="block admin-image">
				...
				<?php if($this->getAction()->id == 'update' && !empty($model->image_filename) && file_exists($_SERVER['DOCUMENT_ROOT'].Authors::PATH_IMAGE.$model->image_filename) ):
			               
			        echo CHtml::image(Authors::PATH_IMAGE.$model->image_filename).'<br />';  
			    	...
			    	echo CHtml::image('http://placehold.it/150x150').'<br />';   
			    endif; ?>
	...
	*/?> 
			...
			<div class="block">
				...
				<?php echo $form->checkBox($model,'photographer',array('class' => 'ibutton')); ?>
		...
		<?php if(count($this->languageList) > 0): ?>
				...
				?>
					...
					<div class="tab-pane fade <?=$activeClass;?>" id="tabs-<?=$lang_id;?>">
						...
						<div class="row-elements">
							<?php echo $form->label($model_transfer,'last_name'); ?>
							<?php echo $form->textField($model_transfer,'last_name['.$lang_id.']',array('size'=>60, 'maxlength'=>255, 'value' => $model_transfer->last_name)); ?>
							<?php echo $form->error($model_transfer,'last_name'); ?>
						</div>

						<div class="row-elements">
							<?php echo $form->label($model_transfer,'post'); ?>
							<?php echo $form->textField($model_transfer,'post['.$lang_id.']',array('size'=>60, 'maxlength'=>255, 'value' => $model_transfer->post)); ?>
							<?php echo $form->error($model_transfer,'post'); ?>
						</div>
