...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Authors::model()->getAttributeLabel('id');?></th>
	            <th><?=AuthorsTransfer::model()->getAttributeLabel('name');?> [ru]</th> 
	            <th><?=Authors::model()->getAttributeLabel('code_name');?></th>    
	            <th width="1%"><?=Authors::model()->getAttributeLabel('photographer');?></th>
	            <th width="1%"><?=Authors::model()->getAttributeLabel('active');?></th>
