...
<?php else: ?> 
	...
	<div class="content noPad">
	    <table class="responsive table table-bordered" >
	        <thead>
	          <tr>
	            <th width="1%"><?=Users::model()->getAttributeLabel('id');?></th>
	            <th><?=Users::model()->getAttributeLabel('name');?></th>  
	            <th><?=Users::model()->getAttributeLabel('provider');?></th>  


	            <th width="1%"><?=Users::model()->getAttributeLabel('active');?></th>
