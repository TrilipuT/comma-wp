...
if(!defined('PHPWORD_BASE_PATH')) {
    define('PHPWORD_BASE_PATH', dirname(__FILE__) . DIRECTORY_SEPARATOR);
 	 

    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/Autoloader.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/DocumentProperties.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/Template.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/TOC.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/Style.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/Section.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/Media.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/protected/extensions/phpword'.'/PHPWord/IOFactory.php'; 
