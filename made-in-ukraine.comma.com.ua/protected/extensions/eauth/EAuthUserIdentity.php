...
class EAuthUserIdentity extends CBaseUserIdentity {
	...
	public function authenticate() {
		if ($this->service->isAuthenticated) {
			...
			$this->setState('url',  $this->service->getAttribute('url'));
			$this->setState('nick', $this->service->getAttribute('nick'));
			$this->setState('file_photo', $this->service->getAttribute('file_photo')); 

			$this->setState('town', $this->service->getAttribute('town')); 
