...
class LinkedinOAuthService extends EOAuthService {
	...
	protected function fetchAttributes() {
		$info = $this->makeSignedRequest('http://api.linkedin.com/v1/people/~:(id,first-name,last-name,public-profile-url,headline,picture-url)', array(), false); // json format not working :(
		...
		$this->attributes['file_photo'] = $info['picture-url'];    
	}
