...
class VKontakteOAuthService extends EOAuth2Service {
	...
	protected function fetchAttributes() {
		$info = (array)$this->makeSignedRequest('https://api.vk.com/method/users.get.json', array(
			'query' => array(
				'uids' => $this->uid,
				'fields' => 'nickname, photo_big', // uid, first_name and last_name is always available
		...
		$this->attributes['file_photo'] = $info->photo_big;
		$this->attributes['town'] 		= $info->city;
...
/*
	...
	protected function getCodeUrl($redirect_uri) {
		...
		$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/login?service=vkontakte';
