<tr class="advads-group-row">
    <td>
        <input type="hidden" class="advads-group-id" name="advads-groups[<?php echo $group->id; ?>][id]"
        ...
        <div class="hidden advads-usage">
            <label><?php _e( 'shortcode', 'advanced-ads' ); ?>
                <code><input type="text" onclick="this.select();" style="width: 200px;"
                             value='[the_ad_group id="<?php echo $group->id; ?>"]'/></code>
            </label><br/>
            <label><?php _e( 'template', 'advanced-ads' ); ?>
                <code><input type="text" onclick="this.select();"
                             value="the_ad_group(<?php echo $group->id; ?>);"/></code>
            </label>
