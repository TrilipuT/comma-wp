<tr class="hidden advads-ad-group-form">
    <td colspan="3">
        ...
        <label><strong><?php _e( 'Description', 'advanced-ads' ); ?></strong><input type="text"
                                                                                    name="advads-groups[<?php
		                                                                            echo $group->id; ?>][description]"
                                                                                    value="<?php echo $group->description; ?>"/></label><br/>
        ...
        <div class="advads-ad-group-number">
            <label><strong><?php _e( 'Number of visible ads', 'advanced-ads' ); ?></strong>
                <select name="advads-groups[<?php echo $group->id; ?>][ad_count]"><?php
					...
					<?php endfor;
					?>
                    <option <?php selected( $group->ad_count, 'all' ); ?>
                            value="all"><?php _ex( 'all', 'option to display all ads in an ad groups', 'advanced-ads' ); ?></option>
                </select>
            </label>
        ...
        <table class="advads-group-ads">
            <thead>
            <tr>
                <th><?php _e( 'Ad', 'advanced-ads' );
					?></th>
                <th colspan="2"><?php _e( 'weight', 'advanced-ads' ); ?></th>
            </tr>
            </thead>
            <tbody>
			<?php
