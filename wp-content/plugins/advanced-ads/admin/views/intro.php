    ...
    <div class="feature-section three-col">
        <div class="col">
            ...
            <div class="advads-admin-notice">
                <p>
                    <button type="button" class="button button-hero button-primary advads-notices-button-subscribe"
                            data-notice="nl_free_addons"><?php echo __( 'Subscribe me now', 'advanced-ads' ); ?></button>
                </p>
            </div>
        </div>
        <div class="col">
        ...
        <div class="col">
            ...
            <ul>
                <li>
                    <a href="<?php echo ADVADS_URL . '/manual/placements/#utm_source=advanced-ads&utm_medium=link&utm_campaign=intro'; ?>"
                       target="_blank"><?php _e( 'List of all available placements', 'advanced-ads' ); ?></a></li>
                <li><a href="<?php echo admin_url( 'admin.php?page=advanced-ads-placements' ); ?>"
                       target="_blank"><?php _e( 'Create a placement', 'advanced-ads' ); ?></a></li>
            </ul>
        </div>
    </div>
</div>