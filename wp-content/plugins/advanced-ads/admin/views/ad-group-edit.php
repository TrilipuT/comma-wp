...
<div class="wrap">
    ...
    <form name="editgroup" id="editgroup" method="post"
          action="<?php echo Advanced_Ads_Groups_List::group_page_url(); ?>"
        ...
        <table class="form-table">
			...
			<?php if ( ! global_terms_enabled() ) { ?>
                <tr class="form-field">
                    ...
                    <td><input name="slug" id="slug" type="text" value="<?php if ( isset( $tag->slug ) ) {
                        ...
                        <p class="description"><?php _e( 'An id-like string with only letters in lower case, numbers, and hyphens.', 'advanced-ads' ); ?></p>
                    </td>
                </tr>
			<?php }
            ...
            <tr class="form-field">
                ...
                <td><textarea name="description" id="description" rows="5" cols="50"
                              class="large-text"><?php echo $text; // textarea_escaped ?></textarea></td>
            </tr>
			<?php
