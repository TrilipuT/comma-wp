...
<div class="advads-option-list">
    ...
    <div id="advanced-ad-output-position">
        <label><input type="radio" name="advanced_ad[output][position]" value=""
                      title="<?php _e( '- default -', 'advanced-ads' );
		              ?>" <?php if ( empty( $options['position'] ) ) {
				checked( 1, 1 );
			} ?>/><?php _e( 'default', 'advanced-ads' ); ?></label>
        <label title="<?php _e( 'left', 'advanced-ads' ); ?>"><input type="radio" name="advanced_ad[output][position]"
                                                                     value="left"
        ...
        <label title="<?php _e( 'center', 'advanced-ads' ); ?>"><input type="radio" name="advanced_ad[output][position]"
                                                                       value="center"
				<?php if ( isset( $options['position'] ) ) {
        ...
        <label title="<?php _e( 'right', 'advanced-ads' ); ?>"><input type="radio" name="advanced_ad[output][position]"
                                                                      value="right"
				<?php if ( isset( $options['position'] ) ) {
        ...
        <p><label><input type="checkbox" name="advanced_ad[output][clearfix]"
                         value="1"<?php if ( isset( $options['clearfix'] ) ) {
    ...
    <label class='label advads-hide-in-wizard'
           for="advads-output-wrapper-id"><?php _e( 'container ID', 'advanced-ads' ); ?></label>
    <div class="advads-hide-in-wizard">
        <input type="text" id="advads-output-wrapper-id" name="advanced_ad[output][wrapper-id]"
               value="<?php if ( isset( $options['wrapper-id'] ) ) {
    ...
    <hr class="advads-hide-in-wizard"/>
    <label class='label advads-hide-in-wizard'
           for="advads-output-wrapper-class"><?php _e( 'container classes', 'advanced-ads' ); ?></label>
    <div class="advads-hide-in-wizard">
        <input type="text" id="advads-output-wrapper-class" name="advanced_ad[output][wrapper-class]"
               value="<?php if ( isset( $options['wrapper-class'] ) ) {
    ...
    <hr class="advads-hide-in-wizard"/>
    <label for="advads-output-debugmode"
           class="label advads-hide-in-wizard"><?php _e( 'Enable debug mode', 'advanced-ads' ); ?></label>
    <div class="advads-hide-in-wizard">
        <input id="advads-output-debugmode" type="checkbox" name="advanced_ad[output][debugmode]"
               value="1"<?php if ( isset( $options['debugmode'] ) ) {
			checked( $options['debugmode'], 1 );
		} ?>/>

        <a href="<?php echo ADVADS_URL; ?>manual/ad-debug-mode/#utm_source=advanced-ads&utm_medium=link&utm_campaign=ad-debug-mode"
