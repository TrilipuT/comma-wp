...
?>
    <div id="advads-display-conditions"><?php
		...
		if ( ! is_array( $options ) || ! count( $options ) ) :
            ...
            <p>
            <button type="button"
                    class="advads-video-link-inline button button-primary"><?php _e( 'Watch video', 'advanced-ads' ); ?></button><?php
				...
				foreach ( $options as $_index => $_options ) :
					...
					if ( method_exists( $metabox[0], $metabox[1] ) ) {
                        ...
                        <td class="advads-conditions-type"
                            data-condition-type="<?php echo $_options['type']; ?>"><?php echo $display_conditions[ $_options['type'] ]['label']; ?></td>
                        <td><?php
        ...
        <input type="hidden" id="advads-display-conditions-index"
               value="<?php echo is_array( $options ) ? count( $options ) : 0; ?>"/>
    </div>
