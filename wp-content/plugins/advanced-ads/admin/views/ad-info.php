<div id="advads-ad-info">
    ...
    <label><span><?php _e( 'theme function', 'advanced-ads' ); ?></span>
        <pre><input type="text" onclick="this.select();"
                    value="&lt;?php the_ad(<?php echo $post->ID; ?>); ?&gt;"/></pre>
    </label>
...
<div id="advads-ad-description">
	...
	<?php else : ?>
        <button type="button"
                onclick="advads_toggle('#advads-ad-description textarea'); advads_toggle('#advads-ad-description button')"><?php _e( 'Add a description', 'advanced-ads' ); ?></button>
	<?php endif; ?>
