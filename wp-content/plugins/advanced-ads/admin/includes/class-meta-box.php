...
class Advanced_Ads_Admin_Meta_Boxes {
	...
	public static function dashboard_widget_function( $post, $callback_args ) {
		...
		if ( ! isset( $notice_options['closed'][ $_notice ] ) ) {
            ...
            <p>
                <button type="button" class="button-primary advads-notices-button-subscribe"
                        data-notice="<?php echo $_notice ?>"><?php _e( 'Get the tutorial via email', 'advanced-ads' ); ?></button>
            </p>
            </div><?php
		}
		...
		if ( ! isset( $notice_options['closed'][ $_notice ] ) ) {
            ...
            <p>
                <button type="button" class="button-primary advads-notices-button-subscribe"
                        data-notice="<?php echo $_notice ?>"><?php _e( 'Get AdSense tips via email', 'advanced-ads' ); ?></button>
            </p>
            </div><?php
		}
		...
		self::dashboard_cached_rss_widget( 'advads_dashboard_widget', array(
			'self',
			'dashboard_widget_function_output'
		), array( 'advads' => $feeds ) );

		// add markup for utm variables
		// todo: move to js file
		?>
        <script>jQuery('#advads_dashboard_widget .rss-widget a').each(function () {
                this.href = this.href + '#utm_source=advanced-ads&utm_medium=rss-link&utm_campaign=dashboard';
            })</script><?php
	}
	...
	public function add_meta_boxes() {
		...
		add_meta_box(
			'ad-main-box', __( 'Ad Type', 'advanced-ads' ), array(
			$this,
			'markup_meta_boxes'
		...
		add_meta_box(
			'ad-parameters-box', __( 'Ad Parameters', 'advanced-ads' ), array(
			$this,
			'markup_meta_boxes'
		), $post_type, 'normal', 'high'
		);
		add_meta_box(
			'ad-output-box', __( 'Layout / Output', 'advanced-ads' ), array(
			$this,
			'markup_meta_boxes'
		), $post_type, 'normal', 'high'
		);
		add_meta_box(
			'ad-display-box', __( 'Display Conditions', 'advanced-ads' ), array(
			$this,
			'markup_meta_boxes'
		), $post_type, 'normal', 'high'
		);
		add_meta_box(
			'ad-visitor-box', __( 'Visitor Conditions', 'advanced-ads' ), array(
			$this,
			'markup_meta_boxes'
		), $post_type, 'normal', 'high'
		);
	...
	public function add_dashboard_widget() {
		...
		add_meta_box( 'advads_dashboard_widget', __( 'Ads Dashboard', 'advanced-ads' ), array(
			$this,
