...
class Advanced_Ads_Overview_Widgets_Callbacks {
	...
	public static function setup_overview_widgets( $screen ) {
		...
		if ( ! isset( $screen->id ) || $screen->id !== 'toplevel_page_advanced-ads' ) {
			return;
		}
		...
		add_meta_box( 'advads_overview_addon_responsive', __( 'Responsive and Mobile ads', 'advanced-ads' ),
			array(
				'Advanced_Ads_Overview_Widgets_Callbacks',
				'render_add_on_responsive'
			), $screen->id, 'side', 'high' );
		add_meta_box( 'advads_overview_addon_geotargeting', __( 'Geo Targeting', 'advanced-ads' ),
			array(
				'Advanced_Ads_Overview_Widgets_Callbacks',
				'render_add_on_geotargeting'
			), $screen->id, 'side', 'high' );
	...
	public static function render_subscribe() {
		...
		if ( ! isset( $options['closed'][ $_notice ] ) && ! $is_subscribed ) {
            ...
            <button type="button" class="button-primary advads-notices-button-subscribe"
                    data-notice="<?php echo $_notice ?>"><?php _e( 'Join now', 'advanced-ads' ); ?></button>
            </div><?php
		}
		...
		if ( ! isset( $options['closed'][ $_notice ] ) ) {
            ...
            <button type="button" class="button-primary advads-notices-button-subscribe"
                    data-notice="<?php echo $_notice ?>"><?php _e( 'Subscribe me now', 'advanced-ads' ); ?></button>
            </div><?php
		}
		...
		if ( ! isset( $options['closed'][ $_notice ] ) && ! $is_subscribed ) {
            ...
            <button type="button" class="button-primary advads-notices-button-subscribe"
                    data-notice="<?php echo $_notice ?>"><?php _e( 'Send it now', 'advanced-ads' ); ?></button>
            </div><?php
		}
	...
	public static function render_help() {
        ...
        <p><a class="button button-primary"
              href="mailto:support@wpadvancedads.com?subject=<?php printf( __( 'Help with ads on %s', 'advanced-ads' ), home_url() ); ?>"><?php
	...
	public static function render_add_on_pro() {
		...
		?><p><?php _e( 'Ad management for advanced websites.', 'advanced-ads' ); ?></p>
        <ul class='list'>
        ...
        </ul><p><a class="button button-primary"
                   href="<?php echo ADVADS_URL; ?>add-ons/advanced-ads-pro/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
                   target="_blank"><?php
	...
	public static function render_add_on_tracking() {
		...
		?><p><?php _e( 'Track the impressions of and clicks on your ads.', 'advanced-ads' ); ?></p>
        <ul class='list'>
            ...
            <li><?php _e( 'group stats by day, week or month', 'advanced-ads' ); ?></li>
                   ...
                   href="<?php echo ADVADS_URL; ?>add-ons/tracking/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
                   target="_blank"><?php
	...
	public static function render_add_on_responsive() {
		...
		?><p><?php _e( 'Display ads based on the size of your visitor’s browser or device.', 'advanced-ads' ); ?></p>
        <ul class='list'>
            ...
            <li><?php _e( 'list all ads by their responsive settings', 'advanced-ads' ); ?></li>
                   ...
                   href="<?php echo ADVADS_URL; ?>add-ons/responsive-ads/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
                   target="_blank"><?php
	...
	public static function render_add_on_geotargeting() {
		...
		?><p><?php _e( 'Target visitors by their geo location.', 'advanced-ads' ); ?></p>
        <ul class='list'>
        </ul><p><a class="button button-primary"
                   href="<?php echo ADVADS_URL; ?>add-ons/geo-targeting/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
                   target="_blank"><?php
	...
	public static function render_add_on_sticky() {
        ...
        <ul class='list'>
            ...
            <li><?php _e( 'build anchor ads not only on mobile devices', 'advanced-ads' ); ?></li>
                   ...
                   href="<?php echo ADVADS_URL; ?>add-ons/sticky-ads/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
                   target="_blank"><?php
	...
	public static function render_add_on_layer() {
        ...
        <ul class='list'>
            ...
            <li><?php _e( 'allow users to close the popup', 'advanced-ads' ); ?></li>
                   ...
                   href="<?php echo ADVADS_URL; ?>add-ons/popup-and-layer-ads/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
                   target="_blank"><?php
	...
	public static function render_add_on_slider() {
        ...
        <p><a class="button button-primary"
              href="<?php echo ADVADS_URL; ?>add-ons/slider/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
              target="_blank"><?php
	...
	public static function render_add_on_sellingads() {
        ...
        <p><a class="button button-primary"
              href="<?php echo ADVADS_URL; ?>add-ons/selling-ads/#utm_source=advanced-ads&utm_medium=link&utm_campaign=overview-add-ons"
              target="_blank"><?php
