...
class Advanced_Ads_AdSense_Admin {
	...
	public function render_settings_adsense_id() {
		...
		?><input type="text" name="<?php echo GADSENSE_OPT_NAME; ?>[adsense-id]" id="adsense-id" size="32"
                 value="<?php echo $adsense_id; ?>" />
	...
	public function render_settings_adsense_limit() {
		...
		?><label><input type="checkbox" name="<?php echo GADSENSE_OPT_NAME; ?>[limit-per-page]"
                        value="1" <?php checked( $limit_per_page ); ?> />
	...
	public function render_settings_adsense_page_level() {
		...
		?><label><input type="checkbox" name="<?php echo GADSENSE_OPT_NAME; ?>[page-level-enabled]"
                        value="1" <?php checked( $page_level ); ?> />
