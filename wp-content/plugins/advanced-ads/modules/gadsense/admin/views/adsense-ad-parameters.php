...
?>
    <input type="hidden" id="advads-ad-content-adsense" name="advanced_ad[content]"
           value="<?php echo esc_attr( $json_content ); ?>"/>
...
<?php endif; ?>
    ...
    <div>
        ...
        <a href="<?php echo ADVADS_URL . 'manual/adsense-ads/#adsense-ad-types'; ?>"
...
<?php if ( $use_paste_code ) : ?>
    <div id="pastecode-div" style="display: none;">
        <div id="pastecode-container">
            ...
            <hr/>
            <textarea rows="15" cols="55" id="pastecode-content"></textarea>
            <hr/>
            <button class="button button-primary"
                    id="submit-pastecode"><?php _e( 'Get details', 'advanced-ads' ); ?></button>&nbsp;&nbsp;
            <button class="button button-secondary"
                    id="hide-pastecode-div"><?php _e( 'Close', 'advanced-ads' ); ?></button>
