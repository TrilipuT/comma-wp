...
class Advanced_Ads_Ad_Type_Image extends Advanced_Ads_Ad_Type_Abstract {
	...
	public function render_parameters( $ad ) {
		...
		_e( 'Insert File', ADVADS_SLUG ); ?>" data-uploader-button-text="<?php _e( 'Insert', ADVADS_SLUG ); ?>"
                onclick="return false;"><?php _e( 'select image', ADVADS_SLUG ); ?></button>
        <a id="advads-image-edit-link" href="<?php if ( $id ) {
			echo get_edit_post_link( $id );
		} ?>"><?php _e( 'edit', ADVADS_SLUG ); ?></a>
        </p>
