	...
	public function __construct() {
		...
		$this->conditions = apply_filters( 'advanced-ads-visitor-conditions', array(
			'mobile'   => array( // type of the condition
				...
				'metabox'     => array( 'Advanced_Ads_Visitor_Conditions', 'mobile_is_or_not' ),
				// callback to generate the metabox
				'check'       => array( 'Advanced_Ads_Visitor_Conditions', 'check_mobile' ),
				// callback for frontend check
				'helplink'    => ADVADS_URL . 'manual/display-ads-either-on-mobile-or-desktop/#utm_source=advanced-ads&utm_medium=link&utm_campaign=edit-visitor-mobile'
			...
			'loggedin' => array(
				...
				'metabox'     => array( 'Advanced_Ads_Visitor_Conditions', 'metabox_is_or_not' ),
				// callback to generate the metabox
				'check'       => array( 'Advanced_Ads_Visitor_Conditions', 'check_logged_in' )
				// callback for frontend check
			),
		) );
