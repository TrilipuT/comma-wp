...
class Advanced_Ads_Ad_Debug {
    ...
    <tr>
        <th></th>
        <th><?php _e( 'current query', 'advanced-ads' ); ?></th>
        <th><?php _e( 'main query', 'advanced-ads' ); ?></th>
    </tr></thead><?php
		foreach ( $diff_current as $_key => $_value ) {
            ...
            <td><?php if ( isset( $diff_main[ $_key ] ) ) {
					echo $diff_main[ $_key ];
				} ?></td></tr><?php
		}
		?></table><?php
