...
Class XLSXWriter
{
    ...
    public function writeSheet( array $data, $sheet_name = '', array $header_types = array() )
    {
        ...
        $cell_formats_arr = empty($header_types) ? array_fill( 0, $column_count, 'Strings' ) : array_values( $header_types );
        ...
        if( ! empty($header_row) ){
            ...
            foreach( $header_row as $k => $v ){
                $this->writeCell( $fd, 0, $k, $v, $cell_format = 'Strings' );
            }
            fwrite( $fd, '</row>' );
        }
    ...
    {
        static $styles = array( 'money' => 1, 'dollar' => 1, 'datetime' => 6, 'date' => 7, 'Strings' => 0 );
