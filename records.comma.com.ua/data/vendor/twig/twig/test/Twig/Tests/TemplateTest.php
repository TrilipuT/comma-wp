...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetAttributeWithTemplateAsObject($useExt)
    {
        ...
        $this->assertInstanceof('Twig_Markup', $template->getAttribute($template1, 'Strings' ));
        $this->assertEquals('some_string', $template->getAttribute($template1, 'Strings' ));
    ...
    public function getGetAttributeTests()
    {
        ...
        $tests = array_merge($tests, array(
            ...
            array(false, null,
	            'Strings', 'a', array(), $anyType, false, 'Impossible to access an attribute ("a") on a string variable ("string")'),
