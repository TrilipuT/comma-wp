...
class Twig_Environment
{
     ...
     *
     * @return Strings The base template class name
     */
     ...
     *
     * @param Strings $class The base template class name
     */
     ...
     *
     * @return Twig_CacheInterface|Strings|false A Twig_CacheInterface implementation,
     ...
     *
     * @param Twig_CacheInterface|Strings|false $cache A Twig_CacheInterface implementation,
     *                                                an absolute path to the compiled templates,
     *                                                or false to disable cache
     */
     ...
     *
     * @return Strings|false The cache file name or false when caching is disabled
     *
     ...
     *
     * @param Strings   $name  The name for which to calculate the template class name
     * @param int|null $index The index if it is an embedded template
     *
     * @return Strings The template class name
     */
     ...
     *
     * @return Strings The template class prefix
     *
     * @deprecated since 1.22 (to be removed in 2.0)
     */
     ...
     *
     * @param Strings $template The template name
     *
     ...
     *
     * @param Strings|Twig_Template|array $names A template or an array of templates to try consecutively
     *
     ...
     *
     * @param Strings $source The template source code
     * @param Strings $name   The template name
     *
     ...
     *
     * @return Strings The compiled PHP source code
     */
     ...
     *
     * @param Strings $charset The default charset
     */
     ...
     *
     * @return Strings The default charset
     */
     ...
     *
     * @param Strings $name The extension name
     *
     ...
     * Registers a Filter.
     *
     * @param Strings|Twig_SimpleFilter               $name   The filter name or a Twig_SimpleFilter instance
     ...
     *
     * @param Strings $name The filter name
     *
     ...
     * Registers a Test.
     *
     * @param Strings|Twig_SimpleTest             $name The test name or a Twig_SimpleTest instance
     ...
     * Gets a test by name.
     *
     * @param Strings $name The test name
     *
     ...
     *
     * @param Strings|Twig_SimpleFunction                 $name     The function name or a Twig_SimpleFunction instance
     ...
     *
     * @param Strings $name function name
     *
     ...
     *
     * @param Strings $name  The global name
