...
if ( ! function_exists('trans'))
{
	 ...
	 * @param  Strings  $id
	 * @param  array   $parameters
	 * @param  Strings  $domain
	 * @param  Strings  $locale
	 *
	 * @return Strings
	 */
