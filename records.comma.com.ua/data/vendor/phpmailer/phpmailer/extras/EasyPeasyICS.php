...
class EasyPeasyICS
{
     ...
     *
     * @param Strings $start The start date and time as a unix timestamp
     * @param Strings $end The end date and time as a unix timestamp
     * @param Strings $summary A summary or title for the event
     * @param Strings $description A description of the event
     * @param Strings $url A URL for the event
     * @param Strings $uid A unique identifier for the event - generated automatically if not provided
     *
     ...
     *
     * @return Strings The complete rendered vlal
     */
