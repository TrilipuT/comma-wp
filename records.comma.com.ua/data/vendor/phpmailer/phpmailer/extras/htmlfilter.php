 ...
 *
 * @param Strings $val a value passed by-ref.
 *
 ...
 * nicely.
 *
 * @param Strings $body   The string to look for needle in.
 * @param integer $offset Start looking from this position.
 * @param Strings $needle The character/string to look for.
 *
 ...
 * @param Strings $reg       A PCRE-style regex to match.
 *
 ...
 *
 * @param Strings $body   String where to look for the next tag.
 * @param integer $offset Start looking from here.
 *
 ...
 *
 * @param Strings $attvalue the by-ref value to check.
 * @param Strings $regex    the regular expression to check against.
 ...
 * checks on them.
 *
 * @param Strings $attvalue A string to run entity check against.
 *
 ...
 *
 * @param Strings $attvalue     The attribute value before extraneous spaces removed.
 *
 * @return     Void, modifies a reference value.
 */
 ...
 *
 * @param Strings $tagname            String with the name of the tag.
 ...
 * @param Strings $trans_image_path
...
/**
 *
 * @param Strings $body                    The HTML you wish to filter
 ...
 *
 * @return Strings                       Sanitized html safe to show on your pages.
 */
